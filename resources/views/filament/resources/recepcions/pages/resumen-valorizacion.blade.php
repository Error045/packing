<x-filament-panels::page>
    ...
    <div class="hidden print:flex justify-between items-center mb-6 border-b-2 border-gray-800 pb-4" style="display: none;">
        <div>
            ...
            <p style="font-size: 0.85rem; color: #333; margin: 0;">RUT: 76.XXX.XXX-X<br>Casa Matriz:Ruta e-35 Sitio N° 7,La Higuera La Ligua</p>
        </div>
        <div style="text-align: right;">
            <h2 style="font-size: 1.25rem; font-weight: bold; margin: 0; text-transform: uppercase;">INFORME DE VALORIZACIÓN</h2>
    ...
    <style>
        @media print {
            ...
            .print\:hidden, .fi-sidebar, .fi-topbar { 
